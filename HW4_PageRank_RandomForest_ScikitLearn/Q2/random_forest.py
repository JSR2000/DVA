...
class RandomForest(object):
    ...
    def _bootstrapping(self, XX, n):
        ...
        # pick a random sample data and corresponding labels
        smpl_idx = [random.randrange(n) for index in range(n)]
        labels = [XX[index][-1] for index in smpl_idx] 
        samples = [XX[index][:-1] for index in smpl_idx] 
